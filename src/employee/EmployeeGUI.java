...
// method that will match  yes and no to  true and false respectively 
	...
	public void newEmployee()  {
		...
		try {
			...
			if(age==0) {
				error=true;
				JOptionPane.showMessageDialog(this, "must be 18 or Older",
			...
			if (error) {
				JOptionPane.showMessageDialog(this, empty,
					...
					Hourly hourly = new Hourly(totalHours, volunter);
					Salary salary = new Salary(rate,totalHours,volunter);
					Employee emp = new Employee(firstName, lastName, gender, department, dateHolder, age, hourly, salary);
